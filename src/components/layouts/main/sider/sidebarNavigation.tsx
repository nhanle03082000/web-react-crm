...
export const sidebarNavigation: SidebarNavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        title: 'sidebar.danhmucnhomsanpham',
        key: 'product-groups',
      ...
      {
        title: 'sidebar.danhmuclinhvuc',
        key: 'company-fields',
        url: '/setting/company-fields',
      },
      {
        title: 'sidebar.danhmucnganhnghe',
        key: 'company-careers',
        url: '/setting/company-careers',
      },
      {
        title: 'sidebar.danhmucnguongoc',
        key: 'customer-sources',
        url: '/setting/customer-sources',
      },
      {
        title: 'sidebar.quytrinhbanhang',
        key: 'sale-processes',
        url: '/setting/sale-processes',
      },
      {
        title: 'sidebar.danhmucvaitro',
        key: 'roles',
        url: '/setting/roles',
      },
      {
        title: 'sidebar.nguoidung',
        key: 'users',
        url: '/setting/users',
      },
      {
